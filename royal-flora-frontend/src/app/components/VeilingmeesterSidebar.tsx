...
const VeilingmeesterSidebar: React.FC<SidebarProps> = ({
    sidebarVisible,
    aankomendChecked,
    inTePlannenChecked,
    aChecked,
...
<div
        ...
        >
          ...
          <div>
            <input type="checkbox" name="In te plannen producten" id="In te plannen producten" 
...
export default VeilingmeesterSidebar;